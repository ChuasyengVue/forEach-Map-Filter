...
function vowelCount (str){
    ...
    stringArr.forEach(function(letter){
        let lowerCaseLetters = letter.toLowerCase();
        if(vowels.indexOf(lowerCaseLetters) !== -1){
            if(obj[lowerCaseLetters]){
...
/*
Write a function called find which accepts an array and a value and returns the first element in the array that has the same value as the second parameter or undefined if 
